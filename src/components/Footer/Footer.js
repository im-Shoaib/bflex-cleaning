// BFLEX-CLEANING/src/components/Footer/Footer.js
                ...
                <div className="footer-top">
                    ...
                    <div className="footer-col">
                        ...
                        <ul className="footer-list">
                            <li><Link to="#">Kantoorschoonmaak</Link></li>
                            <li><Link to="#">Glas en gevelreiniging</Link></li>
                            <li><Link to="#">Industriele reiniging</Link></li>
                            <li><Link to="#">Afwassers diensten</Link></li>
                            <li><Link to="#">Industriele reiniging</Link></li>
                            <li><Link to="#">Afwassers diensten</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="footer-col">
                        ...
                        <ul className="footer-list">
                            ...
                            <li><Link to="#">Certificeringen</Link></li>
                    ...
                    <div className="footer-col">
                        ...
                        <ul className="footer-list">
                            <li><Link to="#">Offerte aanvragen</Link></li>
                            <li><Link to="#">Stuur een bericht</Link></li>
