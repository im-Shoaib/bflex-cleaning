      ...
      <div className="footer-container">
        <div className="footer-top">
          <div className="footer-col footer-col-brand">
            <img src="/assets/logo.png" alt="BFlex Cleaning" className="footer-logo" />
          ...
          <div className="footer-col">
            ...
            <ul className="footer-list">
              <li><Link to="/service/1">Kantoorschoonmaak</Link></li>
              <li><Link to="/service/2">Glas en gevelreiniging</Link></li>
              <li><Link to="/service/3">Industriele reiniging</Link></li>
              <li><Link to="/service/4">Afwassers diensten</Link></li>
              <li><Link to="/service/5">Industriele reiniging</Link></li>
              <li><Link to="/service/6">Afwassers diensten</Link></li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-list">
              <li><Link to="/contact">Offerte aanvragen</Link></li>
              <li><Link to="/contact">Stuur een bericht</Link></li>
